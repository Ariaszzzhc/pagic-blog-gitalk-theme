      ...
      <aside className="hide_on_mobile">
        <div className="aside_card">
          <a
            ...
            href="#"
            style={{
              backgroundImage: `url("${config.root}assets/czs-close-l.svg")`,
            }}
            onClick={(e) => {
              e.preventDefault();
              // @ts-ignore
            ...
            {Object.entries(config.blog?.social ?? {}).map(([key, user]) => (
              <li key={key} className="flex_center">
                <a
                  ...
                  target="_blank"
                  style={{
                    backgroundImage: `url("${config.root}assets/${SOCIAL_MAP[key].icon}.svg")`,
                  }}
                  onClick={() => {
                    // @ts-ignore
                    document.documentElement.classList.remove("show_aside");
                ...
                <li key={link}>
                    ...
                    className={classnames("flex_center", {
                      active:
                        outputPath === "index.html"
                          ? link === "/"
                          : link !== "/" && `/${outputPath}`.startsWith(link),
                    })}
                    href={link}
                    target={target}
                    onClick={() => {
                  ...
                  >
                    <span
                      className={icon}
                      style={{
                        backgroundImage: `url("${config.root}assets/${icon}.svg")`,
                      }}
                    />
                    {text}
                  </a>
